...
public class Robot extends TimedRobot {
  ...
  public void robotInit() {
    ...
    Button b2 = new JoystickButton(stick, 6);
    Button b4 = new JoystickButton(stick, 2);

    b1.whenPressed(new StartCommand());
    b1.whenReleased(new StopCommand());
    b2.whenPressed(new OpenCommand());
    b2.whenReleased(new CloseCommand());
    b4.whenPressed(new ReverseCommand());
    b4.whenReleased(new StopCommand());
  }
